...
def main():
    print("\n[Start] Starting Reality Simulator Engine...")
    
    # 1. Start Backend in the background
    print("[Start] Booting FastAPI Backend...")
    ...
    # 2. Start Frontend
    print("[Start] Booting React Dashboard...")
    ...
    print("\n[OK] All systems nominal. You can view the dashboard and logs above.")
    ...
    try:
        ...
        print("\n[Stop] Shutting down environment safely...")
